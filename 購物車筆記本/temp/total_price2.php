								...
								<form action="" method="post" style="width: 60%;" enctype="multipart/form-data" class="record2">
                                    ...
                                    <table border="2" width="300" height="300" align=center valign=middle> 
                                        <tr>
                                            ...
                                            <?php
                                                    $sql="SELECT time,price FROM record where time between '2022-05-01' and '2022-05-30'";
                                                    $SQL="SELECT SUM(price) FROM record where time between '2022-05-01' and '2022-05-30'";
