							...
							<div class="col-6 col-8-medium col-12-small">
                                ...
                                <table border="2" width="300" height="300" align=center valign=middle>
                                    <tr>
                                        ...
                                        <?php
                                                $sql="SELECT time,price FROM record where time between '2022-04-01' and '2022-04-30'";
                                                $SQL="SELECT SUM(price) FROM record where time between '2022-04-01' and '2022-04-30'";
